            ...
            new Compressor(file, {
                ...
                success(result) {
                    ...
                    reader.onload = async () => {
                        ...
                        try {
                            const response = await fetch(`http://localhost:4000/api/userLG/${userlg._id}`, {
                                method: 'PATCH',
                                headers: {
        ...
        <Container maxWidth="md">
            ...
            >
                <Fade in={openEditModal}>
                    ...
                    >
                        <EditUserLG userId={userlg._id} handleClose={handleCloseEditModal} onUserUpdate={onUserUpdate} />
                    </Box>
                </Fade>
            </Modal>
            <Modal
