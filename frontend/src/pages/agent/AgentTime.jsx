...
/** --- COMPONENTS --- */
import AgentStatusList from "../../components/agent/AgentStatusList";
...
const AgentTime = () => {
    ...
    const fetchStatus = useCallback(async () => {
        try {
            const response = await fetch('http://localhost:4000/api/status/staff', {
                        ...
                        <CircularProgress />
                            ...
                            <div className="flex flex-col w-full items-center overflow-y-hidden">
                                <div className="w-full">
                                    <AgentStatusList statuses={filteredStatus} onStatusUpdate={handleStatusUpdate} onFilter={handleFilter} />
                                </div>
                            </div>
                        )}
                </div>
